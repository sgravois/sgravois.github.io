// Created by iWeb 3.0.1 local-build-20160105
...
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');fixupAllIEPNGBGs();fixAllIEPNGs('Media/transparent.gif');IMpreload('Contact_files','shapeimage_1','0');IMpreload('Contact_files','shapeimage_3','0');IMpreload('Contact_files','shapeimage_3','1');IMpreload('Contact_files','shapeimage_3','2');IMpreload('Contact_files','shapeimage_3','3');IMpreload('Contact_files','shapeimage_3','4');applyEffects()}
