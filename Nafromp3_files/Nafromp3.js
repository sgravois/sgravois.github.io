...
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');fixupAllIEPNGBGs();fixAllIEPNGs('Media/transparent.gif');IMpreload('Nafromp3_files','shapeimage_1','0');IMpreload('Nafromp3_files','shapeimage_2','0');IMpreload('Nafromp3_files','shapeimage_2','1');IMpreload('Nafromp3_files','shapeimage_2','2');IMpreload('Nafromp3_files','shapeimage_2','3');IMpreload('Nafromp3_files','shapeimage_2','4');IMpreload('Nafromp3_files','shapeimage_2','5');applyEffects()}
