...
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');fixupAllIEPNGBGs();fixAllIEPNGs('Media/transparent.gif');IMpreload('Los_Lobos_MP3_files','shapeimage_2','0');IMpreload('Los_Lobos_MP3_files','shapeimage_2','1');IMpreload('Los_Lobos_MP3_files','shapeimage_2','2');IMpreload('Los_Lobos_MP3_files','shapeimage_2','3');IMpreload('Los_Lobos_MP3_files','shapeimage_2','4');IMpreload('Los_Lobos_MP3_files','shapeimage_2','5');applyEffects()}
